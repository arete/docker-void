...
RUN  yes|/usr/bin/xbps-install -Syu -R https://repo.voidlinux.eu/current  xbps-triggers coreutils base-files glibc-locales bash grep xbps iana-etc tzdata sed  -r /root/voidlinux/root -c /root/voidlinux/cache
